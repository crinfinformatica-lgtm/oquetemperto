...
import { X, Share, MoreVertical, PlusSquare, Smartphone, CheckCircle } from 'lucide-react';
      ...
      <div className="bg-white dark:bg-gray-800 rounded-2xl shadow-2xl w-full max-w-md overflow-hidden relative">
        ...
        <div className="flex border-b border-gray-200 dark:border-gray-700">
          <button 
            ...
            className={`flex-1 py-3 text-sm font-bold transition-colors ${activeTab === 'android' ? 'text-primary border-b-2 border-primary bg-blue-50/50 dark:bg-blue-900/20' : 'text-gray-500 hover:text-gray-700 dark:text-gray-400'}`}
          >
            Android (Chrome)
          </button>
          <button 
            onClick={() => setActiveTab('ios')}
            className={`flex-1 py-3 text-sm font-bold transition-colors ${activeTab === 'ios' ? 'text-primary border-b-2 border-primary bg-blue-50/50 dark:bg-blue-900/20' : 'text-gray-500 hover:text-gray-700 dark:text-gray-400'}`}
          >
            iPhone (iOS)
          </button>
        </div>
